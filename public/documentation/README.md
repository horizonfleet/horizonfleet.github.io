...
- Fuel consumption --> biggest cost factor - Depending on speed, mass, air resistance, truck model, road, driver and more
- Breaking behaviour - Unnecessary behaviour, abrasion - automatic breaking
- Route - Influences breaking behavior: City or Incidents - Influences fuel consumption - Influence Time - Route length - Incidents - Road toll - Speed limit
- Cargo
- Time
