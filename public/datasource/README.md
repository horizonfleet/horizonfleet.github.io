...
Before FleetSim can be extended, further research is neccessry. It is important to find out what the real consumption of a truck is made up of and which core variables are influencing it. It is also necessary to be able to map the behaviour of a real driver and the current technical condition of the truck.
...
- slopeAngel: Always 0 as OSM doesn't provide information about height and slope
